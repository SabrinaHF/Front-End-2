...
let sal_inicial = parseFloat(prompt("Informe o salário inicial do funcionário:"));

let salario = sal_inicial + (sal_inicial * aumento);
...
document.getElementById("resultado").innerHTML = `
    <p>Salário inicial do funcionário: R$ ${sal_inicial.toFixed(2)}</p>
    <p>Salário atual do funcionário: R$ ${salario.toFixed(2)}</p>
`;
